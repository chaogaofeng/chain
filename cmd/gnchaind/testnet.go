...
func testnetCmd(mbm module.BasicManager, genBalIterator banktypes.GenesisBalancesIterator) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a blockchain testnet",
...
Example:
	gnchaind testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
		Aliases: []string{"t"},
	...
	cmd.Flags().String(flagNodeDaemonHome, ".gnchain", "Home directory of the node's daemon configuration")
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		accTokens := sdk.TokensFromConsensusPower(10000000000, sdk.DefaultPowerReduction)
		accStakingTokens := sdk.TokensFromConsensusPower(10000000000, sdk.DefaultPowerReduction)
		coins := sdk.Coins{
			sdk.NewCoin("ugnc", accTokens),
